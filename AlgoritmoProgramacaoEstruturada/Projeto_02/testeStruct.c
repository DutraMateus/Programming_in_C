...
void cadastro()
{
    ...
    printf("%s", usuario[numeroUsuarios].nomeCompleto);
...
{ 
    ...
    //     for (int i = 0; i < numeroUsuarios; i++)
    //     {
    //         strcpy(backup[i].id, usuario[i].id);
    //         strcpy(backup[i].email, usuario[i].email);
    //         strcpy(backup[i].sexo, usuario[i].sexo);
    //         strcpy(backup[i].endereco, usuario[i].endereco);
    //         backup[i].altura = usuario[i].altura;
    //         backup[i].vacina = usuario[i].vacina;
    //     }
    //     printf("\nBackup concluido!:)\n\n");
    //     return;
    // }
